function [cntR_total,sumR_total,cntP_total,sumP_total,scores] = ...
            prScores(supIm,iid,gt,nthresh,method,...
                cntR_total,sumR_total,cntP_total,sumP_total,scores,iter,scorePath)
% function [cntR_total,sumR_total,cntP_total,sumP_total,scores] = ...
%             prScores(supIm,iid,gt,nthresh,method,...
%                 cntR_total,sumR_total,cntP_total,sumP_total,scores,iter,scorePath)
% 
% Save precision-recall results
[thresh,cntR,sumR,cntP,sumP] = symmetryPR(supIm,gt,nthresh);
R = cntR  ./ (sumR  + (sumR ==0));
P  = cntP  ./ (sumP  + (sumP ==0));
